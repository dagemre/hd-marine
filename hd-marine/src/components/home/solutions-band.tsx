...
export async function SolutionsBand() {
  ...
  return (
    <section className="bg-hero-gradient py-20 text-white lg:py-28">
      <Container>
          ...
          <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4 lg:gap-8">
            {items.map((item) => (
              <div key={item.title} className="text-center sm:text-left lg:text-center">
                <span className="mx-0 inline-flex h-14 w-14 items-center justify-center rounded-full bg-white text-primary shadow-lg sm:mx-0 lg:mx-auto">
                  {item.icon}
                </span>
